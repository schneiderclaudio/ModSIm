...
Private SimopHeadsAreWritten As Boolean
...
'***************************
  ...
  End If
  About.lblDisclaimer = "Copyright 1978 - 2006 R. P. King and M. A. Ford Copyright 2007 - 2012 Mineral Technologies International, Inc. http://www.mineraltech.com/"
  About.Show
End Sub
...
'Drives the repetive simulation
  ...
  CumOut = 0
  Load UnitMods
  FrmShowProgress.Top = 2000
  FrmShowProgress.Left = 2000
      ...
      For Value3 = StartValue(3) To EndValue(3) Step StepValue(3)
        ...
        End If
          For Value1 = StartValue(1) To EndValue(1) Step StepValue(1)
            ...
            CumOut = CumOut + 1
            If CumOut >= &H7FFFFFFF Then
               MsgBox "Maximum number of simulations has been reached", vbCritical, "WARNING"
               Exit Sub
            End If
            ...
            Print #37, FlagCode
            If Not SimopHeadsAreWritten Then
              Print #37, "F"
              For I = 1 To 5
                If LevelFlag(I) Then
...
Public Sub RunSimulation(CumOut As Long)
'***************************************
  ...
  If resp = 37 Then
    ...
    Exit Sub
  ElseIf resp = 36 And CumOut <= 1 Then
  ...
  ElseIf resp = 13 Then
    ...
    End If
    Exit Sub
  ElseIf resp >= 10 And CumOut <= 1 Then
...
On Error GoTo SimopError
  ...
  ElseIf SimopResp = -1 And CumOut > 1 Then
     If resp = -1 Then
        SimopHeadsAreWritten = True
     End If
    Exit Sub
  ElseIf SimopResp = 2 And CumOut <= 1 Then
...
DeleteFile RTrim(JobPath) & "CumData.OUT"
