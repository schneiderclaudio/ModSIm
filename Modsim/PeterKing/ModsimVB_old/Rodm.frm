...
Begin VB.Form RODM 
   ...
   Caption         =   "Specify parameters for model RODM"
   ClientHeight    =   4395
   ClientLeft      =   285
   ClientTop       =   1335
   ClientWidth     =   7515
...
Private Sub Form_Load()
  ...
  If CURRMODELDATA(ID).MODEL <> "RODM" Then
...
Private Sub LoadDefault()
    ...
    Parameter(6).text = Str$(5)
    Parameter(7).text = Str$(10)
    Parameter(8).text = Str$(2.513)
