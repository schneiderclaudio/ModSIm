...
Begin VB.Form WDMS 
   ...
   Caption         =   "Specify parameters for model WDMS"
   ClientHeight    =   2745
   ClientLeft      =   300
   ClientTop       =   2310
   ClientWidth     =   7920
   ...
   Begin VB.Label lblParameter 
      Appearance      =   0  'Flat
      BackColor       =   &H00C0C0C0&
      Caption         =   "Exponent for recovery curve"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label lblParameter 
      Appearance      =   0  'Flat
      BackColor       =   &H00C0C0C0&
      Caption         =   "Exponent for effect of size on bypass"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Private Sub Form_Load()
  ...
  If CURRMODELDATA(ID).MODEL <> "WDMS" Then
...
Private Sub LoadDefault()
    OptDefault.Value = -1
    Parameter(0).text = Str$(2.5)
    Parameter(1).text = Str$(0.2)
    Parameter(2).text = Str$(1.5)
End Sub
