...
Begin VB.Form Fmil 
   Appearance      =   0  'Flat
   BackColor       =   &H00C0C0C0&
   Caption         =   "Specify parameters for model FMIL"
   ClientHeight    =   2850
   ClientLeft      =   390
   ClientTop       =   1845
   ClientWidth     =   7920
   ...
   Begin VB.Label lblParameter 
      Appearance      =   0  'Flat
      BackColor       =   &H00C0C0C0&
      Caption         =   "Total residence time in the mill"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label lblParameter 
      Appearance      =   0  'Flat
      BackColor       =   &H00C0C0C0&
      Caption         =   "Critical value of DpSvBA"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label lblParameter 
      Appearance      =   0  'Flat
      BackColor       =   &H00C0C0C0&
      Caption         =   "Critical value of DpSvAB"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label lblParameter 
      Appearance      =   0  'Flat
      BackColor       =   &H00C0C0C0&
      Caption         =   "Ore texture parameter PHIA"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
' Find the current data for this model if any
  If CURRMODELDATA(ID).MODEL <> "FMIL" Then
...
Private Sub LoadDefault()
    Parameter(0).text = Str$(50!)
    Parameter(1).text = Str$(9.8)
    Parameter(2).text = Str$(4.5)
    Parameter(3).text = Str$(10!)
End Sub
