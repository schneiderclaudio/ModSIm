...
C
	...
	Common /WICYCommon/ CycloWashRate
...
c     Honaker model
	...
	D = CycloWashRate
	E = PARAM(4)
	Write(UnitDiagFile,*)' A,B,C,D,E', A,B,C,D,E
...
c     Bhaskar model
	...
	Q = 0.584 * VF**0.57 * SPIG**0.369 * P**0.44 * IR**0.168
	SCOS = Exp(1.352 - 0.07*VF + 0.153*SPIG + 0.066*P - 0.087*IR)
	D50c = Exp(5.503 + 0.032*VF - 0.11*SPIG - 0.89*P + 0.034*IR)
	WRITE(13,*)'Q,SCOS,D50c using Bhaskar',Q,SCOS,D50c
